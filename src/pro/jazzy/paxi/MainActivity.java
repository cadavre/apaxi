...
public class MainActivity extends Activity implements OnClickListener,
	...
	protected void onPrepareDialog(final int id, final Dialog dialog) {
		...
		case DIALOG_ROUTE_MODE:
			...
			final int currentMode = preferences
					.getInt("mode", Route.MIXED_MODE);
		...
		case DIALOG_SETTINGS:
			...
			final String currentFuelPrice = String.valueOf(this.preferences
					.getFloat("fuelPrice", 5.0f));
			final String currentFuelMixed = String.valueOf(this.preferences
					.getFloat("fuelMixed", 7.0f));
			final String currentFuelCity = String.valueOf(this.preferences
					.getFloat("fuelCity", 0));
			final String currentFuelHighway = String.valueOf(this.preferences
					.getFloat("fuelHighway", 0));

			etFuelPrice.setText(currentFuelPrice);
			etFuelMixed.setText(currentFuelMixed);
			etFuelCity.setText(Float.parseFloat(currentFuelCity) == 0 ? ""
					: currentFuelCity);
			etFuelHighway
					.setText(Float.parseFloat(currentFuelHighway) == 0 ? ""
							: currentFuelHighway);
			...
			btnDoneSettings.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					float floatValue = inputValue.isEmpty() ? 0 : Float
							.valueOf(inputValue).floatValue();
					...
					floatValue = inputValue.isEmpty() ? 0 : Float.valueOf(
		...
		case DIALOG_PAYMENT:
					...
					.setOnItemLongClickListener(new OnItemLongClickListener() {
						...
						public boolean onItemLongClick(AdapterView<?> parent,
							...
							ButtonsDialog buttonsDialog = new ButtonsDialog(
									MainActivity.this, viewLocation);
							buttonsDialog.show();
							buttonsDialog
									.setOnAcceptListener(new OnAcceptListener() {

										@Override
										public void onAccept(Dialog dialog) {

											myRoute.removePayment(Payment
													.getInstance(id));
											refreshPaymentsList();
			...
			final EditText etPayment = (EditText) dialog
				...
				public void onClick(View v) {
					...
					if (!inputValue.isEmpty() && floatValue != 0) {
						...
						Toast.makeText(getApplicationContext(),
								"Payment added!", Toast.LENGTH_SHORT).show();
					}
